    ...
    <section class="orders-list reveal" style="--delay:.08s">
        ...
        $orders = [
            [
                ...
                'items'=>[
                    ['name'=>'Pinza de Freno Alto Rendimiento','qty'=>2,'price'=>3450.00, 'img'=>'https://imgs.search.brave.com/nboWokbObEH676CNqKOI6dY6jiclG4SwYr3PtE1XPqI/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9lY2Ru/Ni5nbG9iYWxzby5j/b20vdXBsb2FkL3Av/MTk0L2ltYWdlX3By/b2R1Y3QvMjAyNC0w/MS82NTlmNWZmMGU2/MjI3NDMxOTkuanBn'],
                    ['name'=>'Llanta Deport Aleación X-5','qty'=>2,'price'=>4200.00, 'img'=>'https://imgs.search.brave.com/tdGaueSUmExxHcVp2cAub5kLQgdKbuIarsah0ICz8tQ/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9odHRw/Mi5tbHN0YXRpYy5j/b20vRF9RX05QXzJY/XzkzMDI0MS1NTEE5/NDE0NzExMTc2NV8x/MDIwMjUtVi53ZWJw']
                ],
                'total'=>15300.00
            ],
            [
                ...
                'items'=>[
                    ['name'=>'Filtro de Aceite X200','qty'=>1,'price'=>280.00, 'img'=>'https://imgs.search.brave.com/NeZIk_QOoW3EPgL8St2ZT-XiBsQaCgjGoWFJLoBhQTs/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9tb3Rv/c3ByZW1pdW0uY29t/Lm14L3dwLWNvbnRl/bnQvdXBsb2Fkcy8y/MDIxLzAyL0UwOTAy/MDAzNC00LnBuZw'],
                    ['name'=>'Bujía de Iridio NGK','qty'=>4,'price'=>195.00, 'img'=>'https://imgs.search.brave.com/eOvhoU95sPeCy_oFmBLZ1vw0lKADu-icw_99dCF7qbc/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL0kv/MzF1MFlia2pwWUwu/anBn']
                ],
                'total'=>1060.00
            ],
            [
                ...
                'items'=>[
                    ['name'=>'Neumático Deportivo R18','qty'=>4,'price'=>2450.00, 'img'=>'https://imgs.search.brave.com/TCFbqpX2ZkuXXLFRPJJMIVFyjZZAt_AbtBaXjoME7Cw/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9odHRw/Mi5tbHN0YXRpYy5j/b20vRF9RX05QXzJY/Xzg4NjYyNC1NTFU3/NzEwNDk4NjMzNV8w/NjIwMjQtRS53ZWJw']
                ],
                'total'=>9800.00
            ],
        ];
        ...
        <div class="order-card reveal" style="--delay:{{ 0.06 * $loop->iteration }}s" data-status="{{ $order['status'] }}">
            ...
            <div class="order-card-footer">
                <div class="order-total-wrap">
                    ...
                    <span class="order-total-value">${{ number_format($order['total'], 2) }} MXN</span>
                </div>
