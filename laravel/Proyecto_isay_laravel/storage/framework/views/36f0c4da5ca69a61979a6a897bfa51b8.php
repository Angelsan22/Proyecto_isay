...
<nav>
    ...
    <a href="<?php echo e(route('cliente.login')); ?>" class="fw-bold" style="color:#000">INICIAR SESIÓN</a>
</nav>

<div class="card-form mt-5">
    <h2 class="fw-bold mb-4">Recuperar Contraseña</h2>

    <?php if(session('success')): ?>
        <div class="alert alert-success"><?php echo e(session('success')); ?></div>
    <?php endif; ?>

    <form action="<?php echo e(route('cliente.recuperar.post')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
            <label class="form-label text-muted small">Correo</label>
            <input type="email" name="email" class="form-control" placeholder="hello@correo.com" required>
        </div>
        <div class="mb-3">
            <label class="form-label text-muted small">Código de verificación</label>
            <input type="text" name="codigo" class="form-control" placeholder="••••••••••••" required>
        </div>
        <div class="row g-3 mb-4">
            <div class="col">
                <label class="form-label text-muted small">Contraseña nueva</label>
        ...
        <button type="submit" class="btn btn-naranja w-100 fw-bold">Cambiar contraseña</button>
    </form>

    <p class="text-center mt-3 text-muted small">
        <a href="<?php echo e(route('cliente.login')); ?>">← Regresar a inicio</a>
    </p>
</div>
...
<?php /**PATH C:\laragon\www\Proyecto_ISAY\Proyecto_isay\laravel\Proyecto_isay_laravel\resources\views/clientes/auth/recuperar.blade.php ENDPATH**/ ?>