...
<div class="card-form mt-5">
    ...
    <form action="<?php echo e(route('cliente.registro.post')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
    ...
    <p class="text-center mt-3 text-muted small">
        ¿Ya tienes cuenta? <a href="<?php echo e(route('cliente.login')); ?>">Iniciar Sesión</a>
    </p>
</div>
...
<?php /**PATH C:\laragon\www\Proyecto_ISAY\Proyecto_isay\laravel\Proyecto_isay_laravel\resources\views/clientes/auth/registro.blade.php ENDPATH**/ ?>